...
def main() -> None:
    ...
    benchmark = MCPServerBenchmark(
        ...
        servers=[
            ...
            ServerConfig("minimcp", partial(create_client_server, minimcp_http_server)),
        ],
